...
//let label = ["Jan", "Fab", "Mar", "Apr", "Mai", "Jun"];
//let values = [5500, 400, 10000, 6000, 14000, 1500];
let myData = document.getElementById('myData').value.split(',');
let myLabel = document.getElementById('myLabel').value.split(',');
...
var chart = new Chart(ctx, {
    ...
    data: {
        labels: myLabel,
        //labels: ["Sept", "Oct", "Nov", "Dec", "Jan", "Fab", "Mar", "Apr"],
        datasets: [{
            label: "Income",
